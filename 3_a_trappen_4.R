...
trappe.niveaus          <- list("1" = 1, "2" = seq(1:2), "3" = seq(1:3), "4" = seq(1:4)) 
...
cs                      <- cs1t2 + cs2t3 + cs3t4
cs                      <- as.factor(cs)
level.group             <- substring(as.character(s4), first = 1, last = 1)
